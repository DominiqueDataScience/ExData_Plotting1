#   This 'plot2.R'-script will download the power consumption dataset, if it is missing.
#   Then it will read in the data, take the wanted subset and create a plot where
#   the global active power is plotted against the time of days of interest. 
